export default {
  ...
  aiStudio: {
    keySelector: {
      ...
      loading: '加载密钥中...',
      empty: '暂无可用密钥',
      emptyHint: '请先在「API 密钥」页面创建一个密钥'
    },
    models: {
      title: '模型查询',
      subtitle: '使用所选密钥查询当前可用的模型列表',
      query: '查询模型',
      querying: '查询中...',
      filterPlaceholder: '过滤模型名称...',
      count: '显示 {shown} / 共 {total} 个模型',
      copied: '已复制模型 ID',
      noResults: '未查询到任何模型',
      initialHint: '选择密钥后点击「查询模型」开始',
      clickToCopy: '点击卡片复制模型 ID'
    },
    prompt: {
      title: 'AI 提示词',
      subtitle: '根据主题智能生成高质量绘画提示词',
      modelLabel: '对话模型',
      modelPlaceholder: '例如 gpt-4o-mini',
      modelHint: '用于生成提示词的对话模型，需密钥支持',
      themeLabel: '创作主题',
      themePlaceholder: '描述你想画的内容，例如：黄昏时分海边的灯塔',
      styleLabel: '风格偏好（可多选）',
      generate: '生成提示词',
      generating: '生成中...',
      resultLabel: '生成结果',
      resultPlaceholder: '生成的提示词会显示在这里，可手动编辑',
      resultHint: '可直接编辑，或点击右上角发送到绘图页',
      sendToImage: '用于绘图',
      sentToImage: '提示词已带入绘图页',
      copied: '提示词已复制',
      emptyResult: '模型未返回内容，请重试',
      styles: {
        photorealistic: '写实摄影',
        cinematic: '电影感',
        anime: '动漫',
    ...
    image: {
      title: 'AI 绘图',
      subtitle: '文生图与图生图，开箱即用',
      modeGenerate: '文生图',
      modeEdit: '图生图',
      modelLabel: '绘图模型',
      modelPlaceholder: '例如 gpt-image-2',
      modelHint: '默认 {model}，一般无需修改',
      keyModeLabel: '密钥来源',
      ...
      showPromptHelper: 'AI 帮我写',
      hidePromptHelper: '收起',
      generateAndFill: '生成并填入提示词',
      promptFilled: '提示词已生成并填入',
      sizeLabel: '尺寸',
      countLabel: '数量',
      generate: '开始生成',
      generating: '生成中...',
      emptyHint: '填写提示词后点击「开始生成」',
      emptyResult: '未返回图片，请重试或更换模型',
      promptImported: '已自动填入提示词'
    }
  },
  keys: {
    title: 'API 密钥',
