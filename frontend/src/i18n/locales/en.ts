export default {
  ...
  aiStudio: {
    keySelector: {
      ...
      empty: 'No available keys',
      emptyHint: 'Create a key on the "API Keys" page first'
    },
    models: {
      title: 'Model Explorer',
      subtitle: 'Query available models with the selected key',
      query: 'Query Models',
      querying: 'Querying...',
      ...
      initialHint: 'Select a key and click "Query Models" to start',
      clickToCopy: 'Click card to copy model ID'
    },
    prompt: {
      title: 'AI Prompt',
      subtitle: 'Generate high-quality image prompts from a theme',
      modelLabel: 'Chat Model',
      modelPlaceholder: 'e.g. gpt-4o-mini',
      modelHint: 'Chat model used to generate the prompt',
      themeLabel: 'Theme',
      themePlaceholder: 'Describe what you want to draw, e.g. a lighthouse by the sea at dusk',
      styleLabel: 'Style preferences (multi-select)',
      generate: 'Generate Prompt',
      generating: 'Generating...',
      resultLabel: 'Result',
      resultPlaceholder: 'The generated prompt will appear here and is editable',
      resultHint: 'Edit directly, or send it to the image studio',
      sendToImage: 'Use for Image',
      sentToImage: 'Prompt sent to image studio',
      copied: 'Prompt copied',
      emptyResult: 'The model returned no content, please retry',
      styles: {
    ...
    image: {
      title: 'AI Image',
      subtitle: 'Text-to-image and image-to-image, ready to use',
      modeGenerate: 'Text to Image',
      modeEdit: 'Image to Image',
      modelLabel: 'Image Model',
      modelPlaceholder: 'e.g. gpt-image-2',
      modelHint: 'Default {model}, usually no need to change',
      keyModeLabel: 'Key Source',
      keyModeDefault: 'Default key (free quota)',
      keyModeOwn: 'My own key',
      quotaRemaining: 'Free quota today: {remaining} / {limit} left (shared by text & image to image)',
      quotaUnlimited: 'Admin account, unlimited',
      promptHelperHint: 'Prompt generated by {model}, does not consume image quota',
      ...
      showPromptHelper: 'AI: help me write',
      hidePromptHelper: 'Collapse',
      generateAndFill: 'Generate & fill prompt',
      promptFilled: 'Prompt generated and filled',
      sizeLabel: 'Size',
      countLabel: 'Count',
      generate: 'Generate',
      generating: 'Generating...',
      emptyHint: 'Enter a prompt and click "Generate"',
      emptyResult: 'No image returned, retry or switch model',
      promptImported: 'Prompt auto-filled'
    }
  },
  keys: {
    title: 'API Keys',
