<template>
  ...
  >
        ...
        <div class="sidebar-section">
          <template v-for="item in adminNavItems" :key="item.path">
            ...
            <template v-if="item.children?.length">
              ...
              <!-- Children -->
              <div v-if="!sidebarCollapsed && isGroupExpanded(item)" class="mb-1 ml-4 border-l border-gray-200/50 pl-2 dark:border-white/5">
                <router-link
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-gray-100/50 p-3 dark:border-white/5">
      <!-- Theme Toggle -->
      <button
        @click="toggleTheme"
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/ai-models', label: t('nav.aiModels'), icon: ModelCubeIcon },
    { path: '/ai-image', label: t('nav.aiImage'), icon: ImageIcon },
